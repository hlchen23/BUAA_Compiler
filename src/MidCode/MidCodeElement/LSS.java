...
public class LSS extends MidCode
        implements ABSTRACT_DEF, ABSTRACT_USE {
    private String opt1;
    private String opt2;
    private String dst;

    public LSS(String opt1, String opt2, String dst) {
        super();
        this.opt1 = opt1;
        this.opt2 = opt2;
        this.dst = dst;
    ...
    public void createMipsOpt() {
        if (isDelete) {
            ...
            if (!Utility.isVar(opt1) && !Utility.isVar(opt2)) {
                ...
                MipsFactory.mipsCode += String.format("slt %s, %s, %s\r\n",rDst,r1,r2);
            }
        }
    }
    ...
    public String convert2Assign() {
        if (canConvert2Assign()) {
            ...
            int lss = (optNum1 < optNum2)? 1: 0;
            return String.valueOf(lss);
        }
        else {
            return null;
        }
