...
public class MOD extends MidCode
        implements ABSTRACT_DEF, ABSTRACT_USE {
    private String opt1;
    private String opt2;
    private String dst;

    public MOD(String opt1, String opt2, String dst) {
        super();
        this.opt1 = opt1;
        this.opt2 = opt2;
        this.dst = dst;
    ...
    private void mod_optimizer() {
        MipsFactory.mipsCode += "# ##########BEGIN_MOD_OPT###########\r\n";
        int int_opt2 = Integer.valueOf(opt2);
        boolean isMinus = (int_opt2 < 0);
        int old_int_opt2 = int_opt2;
        ...
        if (int_opt2 == 1) {
            ...
            Register borrowNew = Flow.borrowReg(this);

            MipsFactory.mipsCode += String.format(
                    "li %s, %s\r\n",
                    borrowNew,
                    String.valueOf(old_int_opt2)
            );
        ...
        MipsFactory.mipsCode += "# ##########END_MOD_OPT###########\r\n";
    }
